...
- **S2. Core mechanisms.** The seam with its after-compile check and the upsert refusal; the fake adapter, the in-memory ledger, Tier 1 with the latency case template.
