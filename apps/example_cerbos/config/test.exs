...
# environment: a scenario asks the ledger which commit a decision was made
# under, and compares it with the commit a tightened policy is published as.
config :example_cerbos, commit: "policies-0001"
config :example_cerbos, ledger: ledger
