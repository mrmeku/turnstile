defmodule Turnstile.Relay.FlakyJob do
  @moduledoc """
  ...
  called `Turnstile.Relay.drain_once/1`, so a test says `refuse/1` before
  ...
  use Boundary, top_level?: true, deps: [NimbleOptions, Turnstile.Relay, Turnstile.Relay.TestJob]

  alias Turnstile.Relay.Entry
  alias Turnstile.Relay.Job
  alias Turnstile.Relay.TestJob
