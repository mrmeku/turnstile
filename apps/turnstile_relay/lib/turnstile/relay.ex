defmodule Turnstile.Relay do
  ...
  hands them to whatever is slow. What is slow is a `Turnstile.Relay.Job`,
  ...
  at-least-once delivery in position order, and a job's `c:Turnstile.Relay.Job.deliver/3`
  ...
  alias Turnstile.Relay.Adapter.Runner
