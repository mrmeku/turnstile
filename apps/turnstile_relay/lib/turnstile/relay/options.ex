defmodule Turnstile.Relay.Options do
  @moduledoc """
  ...
  `c:Turnstile.Relay.Job.options_schema/0`, so a job's mistake is reported
  ...
  @schema NimbleOptions.new!(
            ...
            job: [type: :atom, required: true, doc: "The `Turnstile.Relay.Job` module."],
            job_options: [
              type: :keyword_list,
              default: [],
              doc: "The job's own options, validated by its `c:Turnstile.Relay.Job.options_schema/0`."
            ],
