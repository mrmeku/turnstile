...
defmodule Turnstile.Infrastructure.SeamTest do
  ...
  describe "the query bucket" do
    ...
    test "a query without the option is refused naming the function and the caller" do
      ...
      assert Exception.message(error) ==
               "Repo.one/2 on Turnstile.Fixture.Folder carries no decision and no exemption (from Turnstile.Infrastructure.SeamTest)"
    end
