...
|---|---|
| A test on the subject | a principal attribute, a column of the subject's schema or a subquery of the subject, read at the call and sent with the request |
