defmodule Turnstile.Ledger.MixProject do
  ...
  # stream_data is unrestricted because core's conformance templates ship in
  # lib, so core carries it in every environment and a dependent that
  # narrowed it would disagree with core.
