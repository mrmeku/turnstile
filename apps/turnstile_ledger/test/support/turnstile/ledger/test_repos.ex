defmodule Turnstile.Ledger.TestRepos do
  @moduledoc "The repos of the ledger's own test run: the owner role and the application role on each of the two databases, and the repo the schema-dump test hands to its own cluster."
...
defmodule Turnstile.Ledger.TestRepos.CommittedApp do
  @moduledoc "The application-role repo on the committed database, where two transactions can commit for real."
  use Ecto.Repo, otp_app: :turnstile_ledger, adapter: Ecto.Adapters.Postgres
  use Turnstile.Repo
end
