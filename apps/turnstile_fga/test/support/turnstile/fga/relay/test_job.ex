defmodule Turnstile.Fga.Relay.TestJob do
  @moduledoc """
  ...
  use Boundary, top_level?: true, deps: [Ecto, NimbleOptions, Turnstile.Fga.Relay], exports: [Row, Sent]

  import Ecto.Query, only: [from: 2]

  alias Turnstile.Fga.Relay.Entry
  alias Turnstile.Fga.Relay.Job
  alias Turnstile.Fga.Relay.TestJob.Row
  alias Turnstile.Fga.Relay.TestJob.Sent
...
defmodule Turnstile.Fga.Relay.TestJob.Row do
...
defmodule Turnstile.Fga.Relay.TestJob.Sent do
