defmodule Turnstile.Code.CoverageTest do
  ...
  defmodule Reads do
    @moduledoc false
    @spec name(Turnstile.subject(), Turnstile.Turnstile.environment()) :: Ecto.Query.dynamic_expr()
    def name(_subject, _environment), do: dynamic([row], row.name == "public")

    @spec joined(Turnstile.subject(), Turnstile.Turnstile.environment()) :: Ecto.Query.dynamic_expr()
    ...
    @spec raw(Turnstile.subject(), Turnstile.Turnstile.environment()) :: Ecto.Query.dynamic_expr()
    def raw(_subject, _environment), do: dynamic([row], fragment("? = 'public'", row.name))

    @spec mapped(Turnstile.subject(), Turnstile.Turnstile.environment()) :: Ecto.Query.dynamic_expr()
    ...
    @spec parent(Turnstile.subject(), Turnstile.Turnstile.environment()) :: Ecto.Query.dynamic_expr()
