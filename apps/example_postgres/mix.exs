defmodule ExamplePostgres.MixProject do
  use Mix.Project

  def project do
    [
      app: :example_postgres,
      version: "0.1.0",
      build_path: "../../_build",
  ...
  def application do
    [mod: {ExamplePostgres.Application, []}, extra_applications: [:logger]]
  end
  ...
  defp docs do
    [main: "readme", extras: ["README.md": [title: "The example under row-level security"]]]
  end
